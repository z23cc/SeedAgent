...
Decision log for SeedAgent — RF32 through RF53. Current-state
architecture lives in `CLAUDE.md`; this file is the historical record
of which refactors shipped, which were declined, and why.
