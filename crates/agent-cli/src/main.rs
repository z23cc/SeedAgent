...
fn default_repoprompt_working_dirs_cli(
    cwd: &Path,
    working_dirs: Vec<PathBuf>,
    default_cwd: bool,
) -> Vec<PathBuf> {
...
fn repoprompt_output_string_cli(
...
fn compact_single_line_cli(input: &str, max_len: usize) -> String {
